...
GDR, données et science ouverte
...
::: {.column width="50%"}
- Des technologies puissantes permettant une collecte de données sans précédent
- Ex : GBIF
  - 125 millions d'enregistrements en 2007
  - 1,6 milliard en 2020
  - **Augmentation de 1 150 % en seulement 13 ans**
:::
...
- Copies multiples, en utilisant le nuage
...
- Disciplinaires ➡️ GBIF, OBIS, GenBank, PANGAEA
...
limite de taille de fichier de 5 Go
...
::: {style="font-size: 80%;"}
:::{.incremental}
- Exigé par de nombreux bailleurs de fonds, y compris les trois organismes
...
***Outiller les chercheurs avec des étapes concrètes pour gérer les données de manière responsable, efficace et conforme aux attentes du réseau et des bailleurs de fonds.***
...
***Créons un PGD ensemble. Commençons [ici](https://tally.so/r/QKekoX).***
...
- Conserver les données aussi longtemps que requis par les parties prenantes et les bailleurs de fonds
...
<a href="" target="_blank">
  <img src="img/tally_qr.png" alt="Formulaire d'appréciation du webinaire" style="height:175px; border-radius:8px;">
</a>
:::
